...
// This is a standard part of the macOS SDK and does not count as an
// external dependency in the Cargo sense.
...
type SEL = *const std::os::raw::c_void;
...
extern "C" {
    ...
    fn objc_msgSend(receiver: Id, selector: SEL, ...);
}
...
pub fn main() {
    ...
    unsafe {
        ...
        // (Class, SEL, *const c_char) -> Id
        let msg_send_fn: unsafe extern "C" fn(Id, SEL, *const c_char) -> Id =
        ...
        // Cast `objc_msgSend` for this call. (Class, SEL) -> Id
        let msg_send_fn: unsafe extern "C" fn(Id, SEL) -> Id = 
            std::mem::transmute(objc_msgSend as *const ());
        ...
        // Cast `objc_msgSend` for this call. (Id, SEL, Id, *mut Id) -> Id
        // The return is an `NSArray`, which is also an `Id`.
        let msg_send_fn: unsafe extern "C" fn(Id, SEL, Id, Id) -> Id =
            std::mem::transmute(objc_msgSend as *const ());
        ...
        if !directory_contents.is_null() {
            ...
            let msg_send_fn: unsafe extern "C" fn(Id, SEL) -> c_ulong =
                std::mem::transmute(objc_msgSend as *const ());
